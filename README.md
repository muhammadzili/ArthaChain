...
* [Tentang ArthaChain](#tentang-arthachain)
* [Cara Kerjanya](#cara-kerjanya)
  * [Komponen Inti](#komponen-inti)
  * [Blockchain & Transaksi](#blockchain--transaksi)
  * [Dompet & Alamat](#dompet--alamat)
  * [Penambangan, Kesulitan & Pasokan](#penambangan-kesulitan--pasokan)
  * [Jaringan Peer-to-Peer](#jaringan-peer-to-peer)
* [Memulai](#memulai)
  * [Prasyarat](#prasyarat)
  * [Instalasi](#instalasi)
  * [Menjalankan ArthaChain](#menjalankan-arthachain)
* [Penggunaan](#penggunaan)
  * [Aplikasi GUI ArthaChain (`artha_gui.py`)](#aplikasi-gui-arthachain-artha_guipy)
  * [Penambang ArthaChain (`artha_miner.py`)](#penambang-arthachain-artha_minerpy)
* [Struktur Proyek](#struktur-proyek)
* [Batasan & Penyederhanaan](#batasan--penyederhanaan)
...
1.  **Clone atau Unduh Proyek:**
    ```bash
    git clone [https://github.com/muhammadzili/ArthaChain.git](https://github.com/muhammadzili/ArthaChain.git)
    cd ArthaChain
    ```
...
2.  **Mulai Aplikasi GUI ArthaChain:**
